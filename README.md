...
**Key Features:**
- Real-time monitoring of temperature, humidity, and pH data.
- Automatic and manual control of fermentation devices via ESP32.
- Integration with MQTT (Mosquitto) for efficient IoT communication.
- Data visualization using InfluxDB and Grafana dashboards.
- Profile management feature for personalized flavor fermentation.
- Backend communication through a PHP REST API and MySQL database.
